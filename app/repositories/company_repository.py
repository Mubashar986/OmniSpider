...
class CompanyRepository:
    ...
    def upsert_company(self, db: Session, schema: CompanyCreateSchema) -> Company:
        ...
        # Typed JSONB empty-object literal: raw dict literals would reach psycopg2
        # unadapted inside SQL expressions (only typed column binds serialize).
        ...
        stmt = stmt.on_conflict_do_update(
            ...
            set_={
                ...
                "extra_metadata": func.coalesce(Company.extra_metadata, empty_jsonb).op("||")(func.coalesce(excluded.extra_metadata, empty_jsonb)),
                "updated_at": func.now(),
            }
        ).returning(Company)
